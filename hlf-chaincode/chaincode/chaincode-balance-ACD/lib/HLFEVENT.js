...
class HLFEVENT {
  ...
  async hlfevents() {
    const hc = {
      ...
      ACD_ST_EVENT: { eventID: "EACD-ST", invokecc: "SubmitSettlementTxCC", invokeFunc: "submitSettlementTx", channel: "channel1" },
      AAD_AOD_AT_EVENT: { eventID: "EAADAOD-AT", invokecc: "AuthorizeSettlementTxCC", invokeFunc: "authorizeSettlementTx", channel: "channel1" },
      AOD_ACD_BT_EVENT: { eventID: "EAODACD-BT", invokecc: "BalanceSettlementTxCC", invokeFunc: "balanceSettlementTx", channel: "channel1" },
      ACD_AAD_CT_EVENT: { eventID: "EACDAAD-CT", invokecc: "ClearSettlementTxCC", invokeFunc: "clearSettlementTx", channel: "channel1" },
