function ISO8583(message, additionLength) {
	this.fields = {
		...
		"2": ["n", 19, "primaryAccountNumber (PAN)", true, false],
		...
		"7": ["n", 10, "transmissionDate &amp; time", false, false],
		...
		"12": ["n", 6, "time, localTransaction (hhmmss)", false, false],
		"13": ["n", 4, "date, localTransaction (MMDD)", false, false],
		...
		"20": ["n", 3, "panextended, countryCode", false, false],
		...
		"28": ["n", 8, "amount, transactionFee", false, true],
		"29": ["n", 8, "amountSettlementFee", false, true],
		"30": ["n", 8, "amount, transactionProcessingFee", false, true],
		"31": ["n", 8, "amount, settlementProcessingFee", false, true],
		"32": ["n", 11, "acquiringInstitutionIdentificationCode", true, false],
		"33": ["n", 11, "forwardingInstitutionIdentificationCode", true, false],
		"34": ["n", 28, "primaryAccountNumber, extended", true, false],
		...
		"43": ["ans", 40, "cardAcceptorName/location", false, false],
		...
		"49": ["a", 3, "currencyCode, transaction", false, false],
		"50": ["an", 3, "currencyCode, settlement", false, false],
		"51": ["a", 3, "currencyCode, cardholderBilling", false, false],
